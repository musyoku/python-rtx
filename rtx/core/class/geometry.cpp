...
void Shape::set_scale(py::tuple scale)
{
...
void Shape::set_scale(float (&scale)[3])
{
    _scale[0] = scale[0];
    _scale[1] = scale[1];
    _scale[2] = scale[2];
...
void Shape::set_position(py::tuple position)
{
...
void Shape::set_position(float (&position)[3])
{
...
void Shape::set_rotation(py::tuple rotation_rad)
{
...
void Shape::set_rotation(float (&rotation)[3])
{
